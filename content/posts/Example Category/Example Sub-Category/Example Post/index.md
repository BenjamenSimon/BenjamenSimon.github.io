...
description: Sample post with markdown, multiple images, embedded video ect.
menu:
  sidebar:
    name: Sample post
    identifier: example_post
    parent: sub-category
    weight: 30
hero: images/forest.jpg
tags: ["Markdown","Content Organization","Example"]
categories: ["Basic"]
math: true
mermaid: true
---
...
{{< img src="/posts/Example Category/Example Sub-Category/Example Post/images/forest.jpg" align="center" title="Forest">}}
...
{{< img src="/posts/Example Category/Example Sub-Category/Example Post/images/boat.jpg" title="A boat at the sea" >}}

{{< vs 3 >}}

#### A sample image with `height` and `width` attributes.

{{< img src="/posts/Example Category/Example Sub-Category/Example Post/images/boat.jpg" height="400" width="600" title="A boat at the sea" >}}

{{< vs 3 >}}

#### A center aligned image with `height` and `width` attributes.

{{< img src="/posts/Example Category/Example Sub-Category/Example Post/images/boat.jpg" height="400" width="600" align="center" title="A boat at the sea" >}}

{{< vs 3 >}}

#### A image with `float` attribute.

{{< img src="/posts/Example Category/Example Sub-Category/Example Post/images/boat.jpg" height="200" width="500" float="right" title="A boat at the sea" >}}
